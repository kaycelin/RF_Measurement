...
fnum_save={'C:\Users\123\Documents\MATLAB\grant';'QV01Ch1_M10'}
close all
...
if flag_NF_Smithchart
    ...
    fnum_save = 'C:\Users\123\Documents\MATLAB\grant\SNP';
    fnum_xls = 'TEST2.xls';
    ...
    [Output, mu] = SNP(SNPInput, z0, [1:2;1:2], freqs_sc, typeIn2Out, typeStability, typeSmithChar, fnum, fnum_typePlt, fnum_Marker, fnum_axis_sc, fnum_save, [], fnum_legend, fnum_suplot);
